...
def KeyGen(n, message_length=512, false_positive_rate=1e-9, t=3, g=None, r=None, noise_rate=None):
    ...
    generator_matrix = GF.Random((n, k))#生成0,1矩阵(16384,568)
...
def Encode(encoding_key, message=None):
    ...
    error = GF(np.random.binomial(1, noise_rate, n))#(16384,)
...
# posteriors - The posterior expectations of sign(z) as a torch.tensor.后验,z是reverse的潜在空间吧
## Returns:
